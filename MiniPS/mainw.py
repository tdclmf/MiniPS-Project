...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout.addWidget(self.Miniholst, 1, 2, 1, 1)
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 504, 271))
        ...
        sizePolicy4.setHeightForWidth(self.canvas.sizePolicy().hasHeightForWidth())
        self.canvas.setSizePolicy(sizePolicy4)
